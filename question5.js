...
// Connect to MongoDB
mongoose.connect('mongodb+srv://shravanbsc22:shravan123@cluster0.mdroez0.mongodb.net/?retryWrites=true&w=majority', {
...
app.get('/animals/alive', async (req, res) => {
  try {
    ...
    const animals = await Animal.find({ age: { $lt: years } });
    const aliveAnimalCount = animals.length;
